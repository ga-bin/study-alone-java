...
public class MethodTest {
	...
	public static void main(String[] args) {
		...
		// t제네릭타입에 어떤 타입이 들어가야하는지 직접 지정해 줘야 한다.
		Util.boxing(100); // 이런식으로 해도 문제가 없는 것은,
		// util의 boxing메소드의 매개변수가 하나밖에 없고, 매개변수 값이 100이라서 t가 integer라는 것을 자바가 유추하는 것
		
		Pair<Integer, String> p1 = new Pair<>(1, "사과");
		Pair<Integer, String> p2 = new Pair<>(1, "사과");
		
		boolean result1 = Util.compare(p1, p2);
		// 매개변수로 넘어가는 p1과 p2의 <integer, string>을 통해서 자바가 유추하고 있어서 들어간다.
		// 경우에 따라서
